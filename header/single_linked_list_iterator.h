 ...
 * If just want to get data size, just fill pNodeData to NULL
 */
 ...
 */
extern void const  * sll_iterator_peek_curr(struct tSLLIterator *);

/*
 * Return Const Pointer Data of Current Node
 */
extern void const  * sll_iterator_peek_prev(struct tSLLIterator *);

/*
 * Return Const Pointer Data of Next Node
 */
extern void const  * sll_iterator_peek_next(struct tSLLIterator *);
 ...
 */
extern void sll_iterator_insert_after(struct tSLLIterator *,void const  *,size_t);
